...
var CadastroService = /** @class */ (function (_super) {
    ...
    CadastroService.prototype.buscaProduto = function (nomeProdParam) {
        var result = this.getaction(this._buscaProdutos, { NomeProd: nomeProdParam }).map(
        // tslint:disable-next-line:no-shadowed-variable
        function (result) {
            var busca = result;
            return busca;
...
var WebApiComponent = /** @class */ (function () {
    ...
    WebApiComponent.prototype.buscarProdutos = function () {
        var _this = this;
        this.service.buscaProduto(this.NomeProd).subscribe(function (retorno) { return _this.produtos = retorno; });
    };
